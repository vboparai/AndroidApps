package com.example.v.mywidgetapplication;
...
public class NewAppWidgetConfigureActivity extends Activity {
    ...
    private static final String PREFS_NAME = "com.example.v.mywidgetapplication.NewAppWidget";
    ...
    public void btnClick(View theBtn) {

        TextView theTextView = (TextView) findViewById(R.id.tv1);

        theTextView.setText("I just changed the text!");
